...
from lhledge import _identifyLongHaulsMultimodal

class longHaulDetectorMultimodal(_identifyLongHaulsMultimodal._longHaulDetectorMultimodal):
    """docstring for longHaulDetector"""
    def __init__(self, midar_database="", table_date=""):
        _identifyLongHaulsMultimodal._longHaulDetectorMultimodal.__init__(self)
