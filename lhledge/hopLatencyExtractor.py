...
from lhledge import _hopLatencyExtractor

class hopLatencyExtractor(_hopLatencyExtractor._hopLatencyExtractor):
    """docstring for longHaulDetector"""
    def __init__(self, midar_database="", table_date=""):
        _hopLatencyExtractor._hopLatencyExtractor.__init__(self)
    ...
    def computeInterhopLatency(self, traceroute, platform="ripe"):
        super().computeInterhopLatencyBase(traceroute, platform)

    def expandInterhopData(self, alias_resolution=False, node2as_mapping=False, geoloc=False):
    ...
    def getAllInterhopLatencies(self):
